...
if (!strcmp($wp_bb_server_protocol, "HTTP/1.1")) {
	if (array_key_exists('Pragna', $wp_bb_http_headers_mixed) && strpos($wp_bb_http_headers_mixed['Pragma'], 'no-cache') !== FALSE && !array_key_exists('Cache-Control', $wp_bb_http_headers_mixed)) {
